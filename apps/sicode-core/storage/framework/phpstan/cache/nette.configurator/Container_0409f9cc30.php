...
class Container_0409f9cc30 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_0409f9cc30 $container)
			{
	...
	public function createServiceContainer(): Container_0409f9cc30
	{
		return $this;
	}
