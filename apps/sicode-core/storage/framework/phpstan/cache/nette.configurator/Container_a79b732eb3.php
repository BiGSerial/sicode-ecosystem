...
class Container_a79b732eb3 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_a79b732eb3 $container)
			{
	...
	public function createServiceContainer(): Container_a79b732eb3
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'HOSTNAME' => 'ca034da91872',
				'MAIL_PASSWORD' => 'null',
				'MAIL_SCHEME' => 'null',
				'SESSION_ENCRYPT' => 'false',
				'CACHE_PREFIX' => 'sicode_core',
				'MAIL_PORT' => '2525',
				'AWS_USE_PATH_STYLE_ENDPOINT' => 'false',
				'MAIL_MAILER' => 'log',
				'MAIL_FROM_ADDRESS' => 'core@example.test',
				'APP_LOCALE' => 'en',
				'DB_PORT' => '5432',
				'APP_URL' => 'http://localhost:8081',
				'APP_NAME' => 'SICODE CORE',
				...
				'SESSION_DOMAIN' => 'null',
				'SESSION_PATH' => '/',
				'VITE_APP_NAME' => 'SICODE CORE',
				'DB_HOST' => 'sicode-postgres',
				'DB_CONNECTION' => 'pgsql',
				'APP_MAINTENANCE_DRIVER' => 'file',
				'APP_ENV' => 'local',
				'SESSION_DRIVER' => 'file',
				'DB_USERNAME' => 'sicode_core',
				'SESSION_LIFETIME' => '120',
				'MAIL_FROM_NAME' => 'SICODE CORE',
