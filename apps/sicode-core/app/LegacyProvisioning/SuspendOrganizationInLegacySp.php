...
final class SuspendOrganizationInLegacySp
{
    ...
    public function __invoke(Organization $organization): LegacyProvisioningActionResult
    {
        ...
        $idempotencyKey = $this->idempotencyKeys->organization($organization).':suspend';
        ...
        try {
            $httpResult = $this->client->suspendOrganization(
