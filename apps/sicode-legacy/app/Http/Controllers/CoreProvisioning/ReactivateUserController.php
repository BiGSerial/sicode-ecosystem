...
use App\CoreProvisioning\ReactivateLegacyUser;
...
final class ReactivateUserController extends Controller
{
    public function __invoke(
        ...
        ReactivateLegacyUser $reactivateUser,
        ...
        try {
            ...
            $outcome = $reactivateUser($coreSubject, $validated, $clientIdentifier, $context);

            $audit->info('user.reactivated', [
