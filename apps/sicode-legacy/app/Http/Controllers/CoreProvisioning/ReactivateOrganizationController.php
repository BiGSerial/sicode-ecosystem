...
use App\CoreProvisioning\ReactivateLegacyOrganization;
...
final class ReactivateOrganizationController extends Controller
{
    public function __invoke(
        string $coreOrganizationId,
        Request $request,
        AuthenticateProvisioningClient $authenticateClient,
        ReactivateLegacyOrganization $reactivateOrganization,
        ...
        try {
            ...
            $outcome = $reactivateOrganization($coreOrganizationId, $validated, $clientIdentifier, $context);

            $audit->info('organization.reactivated', [
